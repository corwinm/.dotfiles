...
SKETCHYBAR_TEST_LOG="$tmp_dir/sketchybar.log" \
  ...
  NAME=coding-agents \
  "$repo_root/sketchybar/.config/sketchybar/plugins/coding_agents.sh"
grep -Fxq -- 'label=  ' "$tmp_dir/sketchybar.log"
grep -Fxq -- 'label=Agent · one:1.0 · unknown' "$tmp_dir/sketchybar.log"
grep -Fxq -- 'label=Agent · two:1.0 · unknown' "$tmp_dir/sketchybar.log"
...
grep -Fq -- '--set coding-agents background.drawing=off' "$repo_root/sketchybar/.config/sketchybar/plugins/appearance.sh"
grep -Fq -- 'icon.font="$FONT:Normal:18.0"' "$repo_root/sketchybar/.config/sketchybar/sketchybarrc"
grep -Fq -- '--add bracket left_status' "$repo_root/sketchybar/.config/sketchybar/sketchybarrc"
grep -Fq -- '--add bracket system_status' "$repo_root/sketchybar/.config/sketchybar/sketchybarrc"
grep -Fq -- 'background.border_width=3' "$repo_root/sketchybar/.config/sketchybar/sketchybarrc"
grep -Fq -- 'background.corner_radius=12' "$repo_root/sketchybar/.config/sketchybar/sketchybarrc"
